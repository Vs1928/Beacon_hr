    ...
    p.registerPlural(
        ...
        function () {
            return this.iterator(
                ...
                function (a, b) {
                    return a._responsive
                        ? a._responsive._responsiveOnlyHidden()[b]
                        : !1;
                },
                1
            );
...
(function (e) {
                ...
                if (n)
                    if (Array.isArray(n)) this._expandButton(a, n, c, d);
                        ...
                        j &&
                            ...
                            n.init &&
                                n.init.call(g.button(j.node), g, e(j.node), n),
                            f++);
                    }
            }
        },
            ...
            if (
                ...
                "absolute" === k
                    ? ((n = f.position()),
                      ...
                      (m = d.offset().top),
                      (i > m - t || g.dropup) && -l < m && c.css("top", l),
                      (o = "button-right" === g.align ? u - s : o - k),
                      c.css("left", c.position().left + o))
                    : ((k = c.height() / 2),
    ...
    i.Api.register("buttons()", function (a, b) {
        ...
        var c = this.iterator(
            ...
            function (c) {
                if (c._buttons)
                    return p.buttonSelector(
                        p.instanceSelector(a, c._buttons),
                        b
                    );
            },
            !0
        ...
        if (this.context.length) {
            ...
            for (
                ...
                for (var r = [k], q = 0; q < k; q++)
                    (r[q] = c.format.body(f[j], l, q, h[j])), j++;
                n[l] = r;
            }
...
(function (e) {
    ...
    e.extend(m.prototype, {
        ...
        _constructor: function () {
            ...
            e(i).on("keydown" + d, function (b) {
                f || a._key(b);
            });
            if (this.c.blurable)
                e(i).on("mousedown" + d, function (d) {
                    e(d.target).parents(".dataTables_filter").length &&
                        a._blur();
                    e(d.target).parents().filter(b.table().container())
                        .length ||
                        e(d.target).parents("div.DTE").length ||
                        e(d.target).parents("div.editor-datetime").length ||
                        e(d.target).parents().filter(".DTFC_Cloned").length ||
                        a._blur();
                });
            if (this.c.editor) {
                var j = this.c.editor;
                j.on("open.keyTableMain", function (b, c) {
                    "inline" !== c &&
                        a.s.enable &&
                        (a.enable(!1),
                        j.one("close" + d, function () {
                            a.enable(!0);
                        }));
                });
            ...
            if (b.settings()[0].oFeatures.bStateSave)
                b.on("stateSaveParams" + d, function (b, d, c) {
                    c.keyTable = a.s.lastFocus
                        ? a.s.lastFocus.cell.index()
                        : null;
                });
            b.on("column-visibility" + d, function () {
                a._tabInput();
            });
            b.on("draw" + d, function (d) {
                ...
                if (!a.s.focusDraw && a.s.lastFocus) {
                    var c = a.s.lastFocus.relative,
                        ...
                        e = c.row + f.start;
                    0 !== f.recordsDisplay &&
                        (e >= f.recordsDisplay && (e = f.recordsDisplay - 1),
                        a._focus(e, c.column, !0, d));
                }
            });
            ...
            k.getSelection &&
                ...
                e(i).on("paste" + c, function (d) {
                    var d = d.originalEvent,
                        ...
                        g = b.c.editor,
                        h;
                    if (c && (!e || "body" === e.nodeName.toLowerCase()))
                        d.preventDefault(),
                            k.clipboardData && k.clipboardData.getData
                                ? (h = k.clipboardData.getData("Text"))
                                : d.clipboardData &&
                                  d.clipboardData.getData &&
                                  (h = d.clipboardData.getData("text/plain")),
                            g
                                ? g
                                      .inline(c.cell.index())
                                      .set(g.displayed()[0], h)
                                      .submit()
                                : (c.cell.data(h), a.draw(!1));
                }));
        },
        _columns: function () {
            var a = this.s.dt,
                ...
                if (
                    ...
                    var n = function () {
                        j.one("open" + h, function () {
                            ...
                            c &&
                                e(f.table().container()).addClass(
                                    "dtk-focus-alt"
                                );
                            j.on("preSubmitCancelled" + h, function () {
                                setTimeout(function () {
                                    d._focus(g, null, !1);
                                }, 50);
                            });
                            j.on("submitUnsuccessful" + h, function () {
                                d._focus(g, null, !1);
                            });
                            j.one("close" + h, function () {
                                f.keys.enable(!0);
                                f.off("key-blur.editor");
                                j.off(h);
                                e(f.table().container()).removeClass(
                                    "dtk-focus-alt"
                                );
                            });
                        })
        ...
        _focus: function (a, b, c, d) {
            ...
            if (this.s.enable) {
                ...
                if (-1 !== g.length && (a < g.start || a >= g.start + g.length))
                    ...
                    if (c === o || !0 === c)
                        this._scroll(e(k), e(i.body), h, "offset"),
                            (c = j.table().body().parentNode),
                            c !== j.table().header().parentNode &&
                                ((c = e(c.parentNode)),
                                this._scroll(c, c, h, "position"));
                    this.s.lastFocus = {
                        cell: g,
                        node: g.node(),
                        relative: {
                ...
                if (
                    ...
                    if (d)
                        if (this.s.dt.cell(d.node).any()) {
                            var d = this.s.dt,
                                f = this.s.dt.settings()[0].oScroll.sY
                                    ? !0
                                    : !1;
                            if (
                                !(
        ...
        _scroll: function (a, b, c, d) {
            var f = c[d](),
                ...
                a = a.width();
            "position" === d &&
                (f.top += parseInt(c.closest("table").css("top"), 10));
        ...
        _shift: function (a, b, c) {
            ...
            if (g) {
                ...
                "right" === b
                    ...
                    ? i--
                    : "down" === b && i++;
                0 <= i && i < j && -1 !== e.inArray(f, h)
                    ? (a && a.preventDefault(), this._focus(i, f, !0, a))
                    : !c || !this.c.blurable
                    ? a && a.preventDefault()
                    : this._blur();
            }
        ...
        _tabInput: function () {
            ...
            -1 != c &&
                (this.s.tabInput ||
                    ((c = e(
                        '<div><input type="text" tabindex="' + c + '"/></div>'
                    ).css({
                        position: "absolute",
                        height: 1,
                        width: 0,
                    ...
                    c.children().on("focus", function (c) {
                        var e = b.cell(":eq(0)", a._columns(), {
                            page: "current",
                        });
                        e.any() && a._focus(e, null, !0, c);
                    }),
                    (this.s.tabInput = c)),
                (c = this.s.dt
                    .cell(":eq(0)", "0:visible", {
                    ...
                    .node()) && e(c).prepend(this.s.tabInput));
        },
